...
<body>
    ...
    <div class="main-content">
        ...
        <section class="achievements">
            ...
            <ul>
                <li>Recognized as the best cinema in the region for three consecutive years and have hosted numerous
                    film festivals and premieres.</li>
                ...
                <li>Awarded for diverse programming, showcasing a wide range of international and independent films.
                </li>
            </ul>
        </section>
        <section class="comparison">
            ...
            <ul>
                <li>At M-Theater, we provide a premium experience with state-of-the-art technology, superior comfort, and
                    exceptional service.</li>
                <li>We offer a diverse selection of films, including exclusive premieres and independent movies that you
                    won't find anywhere else.</li>
                <li>Our luxurious seating and spacious auditoriums ensure that every guest enjoys a comfortable and
                    immersive viewing experience.</li>
            </ul>
        </section>
        <section class="why-special">
            <h2>Why Watching Movies at M-Theater is Special</h2>
            <ul>
                <li>Experience movies like never before with our immersive screens, surround sound, and a vibrant
                    atmosphere that makes every visit unforgettable.</li>
                <li>Our expansive screens provide a level of detail and clarity that small devices like TVs, mobiles,
                    and PC screens can't match.</li>
                <li>Enjoy powerful, high-quality sound that brings every scene to life, far surpassing the audio
                    capabilities of personal devices.</li>
                <li>Escape from everyday distractions and fully immerse yourself in the cinematic experience without
                    interruptions from notifications or smaller screens.</li>
            </ul>
        </section>
    </div>
    <footer>
