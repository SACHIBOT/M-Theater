    ...
    <div class="main-content">
        <section class="signup">
            <div class="signup-card">
                <h1>Sign Up</h1>
                <form
                    action="signup_process.php<?php echo !empty($_SERVER['QUERY_STRING']) ? '?' . htmlspecialchars($_SERVER['QUERY_STRING']) : ''; ?>"
                    method="POST">
                ...
                <p>Create new account? <a
                        href="signin.php<?php echo !empty($_SERVER['QUERY_STRING']) ? '?' . htmlspecialchars($_SERVER['QUERY_STRING']) : ''; ?>">Sign
                        In</a></p>
            </div>
        </section>
    </div>
