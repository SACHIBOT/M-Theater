    ...
    <div class="main-content">
        <section class="signin">
            <div class="signin-card">
                <h1>Sign In</h1>
                <form
                    action="signin_process.php<?php echo !empty($_SERVER['QUERY_STRING']) ? '?' . htmlspecialchars($_SERVER['QUERY_STRING']) : ''; ?>"
                    method="POST">
                ...
                <p>Create new account? <a
                        href="signup.php<?php echo !empty($_SERVER['QUERY_STRING']) ? '?' . htmlspecialchars($_SERVER['QUERY_STRING']) : ''; ?>">Sign
                        Up</a></p>
            </div>
        </section>
    </div>
